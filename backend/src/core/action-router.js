...
add(['agenda.list','agendas.list'],agendaHandlers.list);
add(['agenda.get','agendas.get'],agendaHandlers.get);
add(['agenda.create','agendas.create'],agendaHandlers.create,'USUARIOS_GESTIONAR');
add(['agenda.update','agendas.update'],agendaHandlers.update,'USUARIOS_GESTIONAR');
add(['agenda.resend.email','agendas.resend.email','agenda.reenviar.correo'],agendaResendHandlers.email,'USUARIOS_GESTIONAR');
...
add(['maintenance.images.large.init','mantenimientos.imagenes.grande.iniciar'], largeEvidenceUploadHandlers.maintenanceInit, maintenanceEditPermissions);
add(['maintenance.images.large.chunk','mantenimientos.imagenes.grande.bloque'], largeEvidenceUploadHandlers.maintenanceChunk, maintenanceEditPermissions);

const knowledgeAliases={list:['knowledge.list','baseConocimientos.list','conocimiento.list','tutorials.list'],get:['knowledge.get','baseConocimientos.get','conocimiento.get','tutorials.get'],create:['knowledge.create','baseConocimientos.create','conocimiento.create','tutorials.create'],update:['knowledge.update','baseConocimientos.update','conocimiento.update','tutorials.update'],delete:['knowledge.delete','baseConocimientos.delete','conocimiento.delete','tutorials.delete'],attachmentUpload:['knowledge.attachments.upload','baseConocimientos.adjuntos.upload','conocimiento.adjuntos.upload'],attachmentDelete:['knowledge.attachments.delete','baseConocimientos.adjuntos.delete','conocimiento.adjuntos.delete'],attachmentPrimary:['knowledge.attachments.primary','knowledge.documents.primary'],attachmentReindex:['knowledge.attachments.reindex','knowledge.documents.reindex'],mediaGet:['knowledge.media.get','knowledge.documents.access','baseConocimientos.media.get','conocimiento.media.get']};
