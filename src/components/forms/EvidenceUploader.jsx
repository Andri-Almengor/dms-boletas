...
function EvidenceUploader({ items, onAdd, onUpdate, onRemove, disabled }) {
  ...
  return (
    <div className="evidence-uploader" data-offline-editing-surface>
      ...
      <div className="info-box"><Icon name="info" /><p>Los videos deben durar máximo 1 minuto y 30 segundos y pesar hasta 300 MB. Los videos mayores de 30 MB se cargan por partes y necesitan internet; los demás archivos conservan el soporte offline actual.</p></div>
