...
export default function MorePage() {
  ...
  return <div className="page page--narrow">
    ...
    <section className="menu-section"><h2>Administración</h2><div className="menu-list">
      ...
      {(hasPermission('CATALOGOS_VER') || hasPermission('CATALOGOS_GESTIONAR')) && <MenuRow to="/catalogos" icon="inventory_2" label="Catálogos" note="Categorías, dispositivos, fabricantes y modelos" />}
