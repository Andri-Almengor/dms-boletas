...
export function createMaintenanceDevice(category = 'Cámaras') {
  return {
    ...
    fechaTrabajo: todayInCostaRica(),
    fechaRegistroDispositivo: new Date().toISOString(),
    tecnicoIds: [],
...
export function mapMaintenanceDevice(row) {
  ...
  return {
    ...
    fechaRegistroDispositivo: pick(row, ['FechaRegistroDispositivo', 'FechaCreacion'], new Date().toISOString()),
...
export function maintenanceDevicePayload(device, maintenanceId) {
  ...
  return {
    ...
    fechaTrabajo: device.fechaTrabajo,
    FechaRegistroDispositivo: device.fechaRegistroDispositivo,
    fechaRegistroDispositivo: device.fechaRegistroDispositivo,
