...
assert.match(agendaPageSource, /Cliente relacionado/);
assert.match(agendaPageSource, /clients\.list/);
assert.match(agendaPageSource, /clienteId/);
...
console.log('✓ agenda operativa: exclusiones, calendario, vínculo por cliente 1:1, separación rápida, recordatorio diario, rutas y asistente');
